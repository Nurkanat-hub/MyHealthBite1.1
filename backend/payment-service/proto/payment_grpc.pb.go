...
type PaymentServiceClient interface {
	...
	GetPaymentHistory(ctx context.Context, in *PaymentHistoryRequest, opts ...grpc.CallOption) (*PaymentHistoryResponse, error)
}
...
func (c *paymentServiceClient) GetPaymentHistory(ctx context.Context, in *PaymentHistoryRequest, opts ...grpc.CallOption) (*PaymentHistoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type PaymentServiceServer interface {
	...
	GetPaymentHistory(context.Context, *PaymentHistoryRequest) (*PaymentHistoryResponse, error)
...
func (UnimplementedPaymentServiceServer) GetPaymentHistory(context.Context, *PaymentHistoryRequest) (*PaymentHistoryResponse, error) {
...
func _PaymentService_GetPaymentHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).GetPaymentHistory(ctx, req.(*PaymentHistoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
