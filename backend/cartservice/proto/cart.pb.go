...
func (x *CartItem) GetDishId() string {
	if x != nil {
		return x.DishId
	}
	return ""
...
func (x *AddToCartRequest) GetDishId() string {
	if x != nil {
		return x.DishId
	}
	return ""
...
func (x *RemoveFromCartRequest) GetDishId() string {
	if x != nil {
		return x.DishId
	}
	return ""
...
const file_proto_cart_proto_rawDesc = "" +
	...
	"\x05Empty2\xac\x01\n" +
	"\vCartService\x120\n" +
	"\tAddToCart\x12\x16.cart.AddToCartRequest\x1a\v.cart.Empty\x12:\n" +
	"\x0eRemoveFromCart\x12\x1b.cart.RemoveFromCartRequest\x1a\v.cart.Empty\x12/\n" +
	"\aGetCart\x12\x14.cart.GetCartRequest\x1a\x0e.cart.CartListB,Z*github.com/nurkanat/cartservice/proto;cartb\x06proto3"
...
var file_proto_cart_proto_depIdxs = []int32{
	...
	5, // 4: cart.CartService.AddToCart:output_type -> cart.Empty
	5, // 5: cart.CartService.RemoveFromCart:output_type -> cart.Empty
	4, // 6: cart.CartService.GetCart:output_type -> cart.CartList
