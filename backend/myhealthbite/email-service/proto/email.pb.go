...
type EmailRequest struct {
	...
	Body          string                 `protobuf:"bytes,3,opt,name=body,proto3" json:"body,omitempty"`       // текст письма
...
const file_proto_email_proto_rawDesc = "" +
	"\n" +
	"\x11proto/email.proto\x12\x05email\"L\n" +
	...
	"\fEmailService\x126\n" +
	"\tSendEmail\x12\x13.email.EmailRequest\x1a\x14.email.EmailResponseB\x15Z\x13email-service/protob\x06proto3"
